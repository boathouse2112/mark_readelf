...
pub fn e_osabi_to_human_string(e_osabi: u8) -> Option<&'static str> {
    match e_osabi {
        abi::ELFOSABI_SYSV => Some("UNIX - System V"),
        abi::ELFOSABI_HPUX => Some("UNIX - HP"),
        abi::ELFOSABI_NETBSD => Some("NetBSD"),
        abi::ELFOSABI_GNU => Some("GNU"),
        abi::ELFOSABI_SOLARIS => Some("Sun Solaris"),
        abi::ELFOSABI_OPENBSD => Some("OpenBSD"),
        abi::ELFOSABI_OPENVMS => Some("OpenVMS"),
        abi::ELFOSABI_NSK => Some("HP Non-Stop Kernel"),
        abi::ELFOSABI_AROS => Some("Amiga"),
        abi::ELFOSABI_FENIXOS => Some("FenixOS"),
        abi::ELFOSABI_CLOUDABI => Some("Nuxi CloudABI"),
        abi::ELFOSABI_OPENVOS => Some("Stratus Technologies OpenVOS"),
        _ => None,
    }
}
